...
export interface INameWrapper extends BaseContract {
  ...
  allFusesBurned: TypedContractMethod<
    [node: BytesLike, fuseMask: BigNumberish],
    [boolean],
    "view"
  >;
  ...
  extendExpiry: TypedContractMethod<
    [node: BytesLike, labelhash: BytesLike, expiry: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  renew: TypedContractMethod<
    [labelHash: BigNumberish, duration: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  unwrapETH2LD: TypedContractMethod<
    [label: BytesLike, newRegistrant: AddressLike, newController: AddressLike],
    [void],
    "nonpayable"
  >;

  upgrade: TypedContractMethod<
    [name: BytesLike, extraData: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  wrap: TypedContractMethod<
    [name: BytesLike, wrappedOwner: AddressLike, resolver: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "isWrapped(bytes32,bytes32)"
  ): TypedContractMethod<[arg0: BytesLike, arg1: BytesLike], [boolean], "view">;
  getFunction(
    nameOrSignature: "isWrapped(bytes32)"
  ): TypedContractMethod<[arg0: BytesLike], [boolean], "view">;
  getFunction(
    nameOrSignature: "metadataService"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "setMetadataService"
  ): TypedContractMethod<[_metadataService: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "setUpgradeContract"
  ): TypedContractMethod<[_upgradeAddress: AddressLike], [void], "nonpayable">;
  getFunction(
