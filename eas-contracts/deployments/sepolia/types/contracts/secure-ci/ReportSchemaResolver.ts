...
export interface ReportSchemaResolverInterface extends Interface {
  ...
  getEvent(nameOrSignatureOrTopic: "ContractReported"): EventFragment;
...
export namespace ContractReportedEvent {
...
export interface ReportSchemaResolver extends BaseContract {
  ...
  getEvent(
    key: "ContractReported"
  ): TypedContractEvent<
    ContractReportedEvent.InputTuple,
    ContractReportedEvent.OutputTuple,
    ContractReportedEvent.OutputObject
  >;

  filters: {
    "ContractReported(uint256,address)": TypedContractEvent<
      ContractReportedEvent.InputTuple,
      ContractReportedEvent.OutputTuple,
      ContractReportedEvent.OutputObject
    >;
    ContractReported: TypedContractEvent<
      ContractReportedEvent.InputTuple,
      ContractReportedEvent.OutputTuple,
      ContractReportedEvent.OutputObject
    >;
